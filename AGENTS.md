...
- `src/lib/game/hipster/` — juego wg_hipster (modos título/año, dificultad, charts iTunes + buscador + playlists Deezer por JSONP)
...
- `tests/unit/` — 32 tests (hipster 21); `tests/e2e/` — 9 casos, incluido P2P real con dos contextos
